...
SMC（Smart Money Concepts）内容爆炸：OB、FVG、流动性猎杀、无数缩写。信息过载之后，我只从中留下两块能写进日常 SOP 的：**自上而下定级**，以及**保护低点/高点被收盘打破就换偏见**。

对学生更简单的版本：**先看大图定方向，再往下找入场；小周期漂亮形态，不能推翻大级别故事。** 其余黑话包默认观望；课程营销层直接弃用。

![供需区当区域而非细线](../../../images/supply-demand.svg)

![SMC Top-down：周/日 → 4H → 1H](../../../images/smc-topdown.svg)

**读图（自上而下）**

- 最上：周/日 —— 只回答「偏见」和「大区在哪」。
- 中间：4H —— 把大区细成可操作的结构与回调路径。
- 最下：1H —— 等 Entry；**禁止**用 1H 形态重新发明一个与日线矛盾的故事。
...
2. 配图：`supply-demand.svg`、`smc-topdown.svg`，示意供需当区域与自上而下流程，仅供教学。
